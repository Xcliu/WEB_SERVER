...
int main(int argc,char *argv[]){
    auto var1 = static_cast<BaseExecutor*>( SONNIE::GET_INSTANCE_BY_NAME("PlusExecutor"));
    auto var2 = static_cast<BaseExecutor*>( SONNIE::GET_INSTANCE_BY_NAME("MinusExecutor"));
    var1->do_exec(1);
    var2->do_exec(1);
    return 0;
}