...
class socket_info_addr_ipv4
{
    ...
    public:
        ...
        explicit socket_info_addr_ipv4( decltype(INADDR_ANY) _ipv4_address=INADDR_ANY, 
...
class socket_info_addr_ipv6
{
    ...
    public:
        socket_info_addr_ipv6(in6_addr _ipv6_address=in6addr_any, int _server_port=8888);
